...
//                showAddForm(request, response);
            ...
            case "findByCountry":
                ...
                break;
            case "findById":
                showGetUserById(request,response);
                break;
            default:
    ...
    private void showGetUserById(HttpServletRequest request, HttpServletResponse response) {
      int id= Integer.parseInt(request.getParameter("id"));
      List<Users> users= iService.getUserById(id);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            case "insert":
                saveInsertUsers(request, response);
//                saveAddUsers(request, response);
    ...
    private void saveInsertUsers(HttpServletRequest request, HttpServletResponse response) {
