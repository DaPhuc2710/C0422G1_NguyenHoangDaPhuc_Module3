...
<form class="m-auto w-25" method="post">
    ...
    <div class="mb-3 " id="s1">
        ...
        <input type="text" class="form-control" id="exampleInputEmail5" aria-describedby="emailHelp" name="extraServices" value="null">
    </div>
    <div class="mb-3" id="s2">
        <label for="exampleInputEmail8" class="form-label">Tiêu chuẩn phòng </label>
        <input type="text" class="form-control" id="exampleInputEmail8" aria-describedby="emailHelp" name="quality"  value="null">
    </div>
    <div class="mb-3" id="s3">
        <label for="exampleInputEmail7" class="form-label">Mô tả tiện nghi khác </label>
        <input type="text" class="form-control" id="exampleInputEmail7" aria-describedby="emailHelp" name="description"  value="null">
    </div>
    <div class="mb-3" id="s4">
        <label for="exampleInputEmail9" class="form-label">Diện tích hồ bơi </label>
        <input type="text" class="form-control" id="exampleInputEmail9" aria-describedby="emailHelp" name="poolArea"  value="0">
    </div>
    <div class="mb-3" id="s5">
        <label for="exampleInputEmail10" class="form-label">Số tầng </label>
        <input type="text" class="form-control" id="exampleInputEmail10" aria-describedby="emailHelp" name="floor" value="0">
    </div>
