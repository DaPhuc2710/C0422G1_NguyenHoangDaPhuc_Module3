                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <div class="col-3">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="#">Adding New Employee</a>
                                    </li>
                                </ul>
                            </li>
                        </div>
                        ...
                        <div class="col-3">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="/customer?action=add">Adding New
                                        Customer</a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="col-3">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="/services">Service List</a></li>
                                    <li><a class="dropdown-item" href="/services?action=add">Adding New Service</a>
                                    </li>
                                </ul>
                            </li>
                        </div>
                        ...
                        <div class="col-3">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="#">Adding New Contract</a>
                                    </li>
                                </ul>
                            </li>
                        </div>
